...
void main() {
  ...
  testWidgets('placeholder-Builder liefert den Shimmer aus shimmerBase/shimmerHi',
      (tester) async {
    await tester.pumpWidget(_wrap(
      const AsmNetworkImage(path: 'https://example.com/bild.jpg'),
    ));
    ...
    final image = tester.widget<CachedNetworkImage>(find.byType(CachedNetworkImage));
    final placeholderWidget = image.placeholder!(tester.element(find.byType(CachedNetworkImage)), 'https://example.com/bild.jpg');
  ...
  testWidgets('errorWidget-Builder liefert dasselbe Fallback-Icon', (tester) async {
    await tester.pumpWidget(_wrap(
      const AsmNetworkImage(path: 'https://example.com/bild.jpg'),
    ));
